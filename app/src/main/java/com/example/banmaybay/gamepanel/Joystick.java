...
public class Joystick {
    ...
    public Joystick(int centerPositionX, int centerPositionY, int outerCircleRadius, int innerCircleRadius) {
        ...
        // Outer and inner circle that makes up Joystick
    ...
    public void setPosition(double positionX, double positionY) {
        this.outerCircleCenterPositionX = (int) positionX;
        this.outerCircleCenterPositionY = (int) positionY;
        this.innerCircleCenterPositionX = (int) positionX;
        this.innerCircleCenterPositionY = (int) positionY;
